...
const EmpEdit=()=>{
    ...
    let api="http://localhost:8000/teacher/editdatashow";
    ...
    return(
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Enter Teacher No.</Form.Label>
        <Form.Control type="text" name="Teacherno"  value={mydata.Teacherno}  onChange={handleInput}/>
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Enter Teacher Name</Form.Label>
        <Form.Control type="text" name="Teachername" value={mydata.Teachername} onChange={handleInput}  />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
